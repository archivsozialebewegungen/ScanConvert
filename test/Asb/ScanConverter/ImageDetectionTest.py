...
class ImageDetectionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.img = (Image.open("Image1.png"), Image.open("Image2.png"))
    ...
    def notestVerifyMasks(self):
        ...
        for i in range(0,len(self.img)):
            bw_img = self.format_conversion_service._binarization_sauvola(self.img[i])
    ...
    def testGrayMask(self):
        ...
        for image in range(0,len(self.img)):
            bw_img = self.format_conversion_service._binarization_sauvola(self.img[image])
