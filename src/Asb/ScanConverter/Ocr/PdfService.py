...
from Asb.ScanConverter.Services import JobDefinition
...
class PdfService:
    ...
    def create_pdf_file(self, job: JobDefinition):
        ...
        for image_info in image_infos:
            ...
            pdf.drawImage(image_info.filepath, 0, 0, width=page_width, height=page_height)
            #add_text_layer(pdf, image, height, dpi)
            pdf.showPage()
        pdf.save()
            
    def add_text_layer(self, pdf, image, height, dpi):
    ...
    def register_invisible_font(self):
